package be.fgov.famhp.vons.backoffice.repository;

import be.fgov.famhp.vons.backoffice.VonsBackOfficeApp;
import be.fgov.famhp.vons.backoffice.config.Constants;
import be.fgov.famhp.vons.backoffice.config.TestSecurityConfiguration;
import be.fgov.famhp.vons.backoffice.config.audit.AuditEventConverter;
import be.fgov.famhp.vons.backoffice.domain.PersistentAuditEvent;
...
import static be.fgov.famhp.vons.backoffice.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
